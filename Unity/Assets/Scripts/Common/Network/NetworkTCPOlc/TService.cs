...
namespace TheMazeRunner
{
	public sealed class TService : AService
	{
		...
		public override void StartListener(SERVICE_TYPE serviceType, IPEndPoint ipEndPoint)
        {
			...
			SynchronizationContextSO.PostNext(this.AcceptAsync);
		}

		public override void StartConnect(SERVICE_TYPE serviceType, IPEndPoint ipEndPoint)
        {
		...
		private void OnComplete(object sender, SocketAsyncEventArgs e)
		{
			switch (e.LastOperation)
			{
				case SocketAsyncOperation.Accept:
					...
					SynchronizationContextSO.Post(()=>{this.OnAcceptComplete(socketError, acceptSocket);});
					break;
				default:
